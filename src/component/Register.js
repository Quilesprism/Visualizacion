...
const Register = () => {
    ...
    const handleRegister = async (e) => {
        ...
        if (!validatePassword(password)) {
            setPasswordError("La contraseña debe tener al menos 8 caracteres, incluyendo un número y una letra mayúscula.");
            return;
        }
        ...
        <div className="container">
            ...
            <div className="login-container">
                ...
                <form onSubmit={handleRegister}>
                    ...
                    <button className="Login" type="submit">Registrarse</button>
                </form>
                <button className="gsi-material-button" onClick={handleAuth0Register}>
                    <div className="gsi-material-button-content-wrapper">
                        ...
                        <span className="gsi-material-button-contents">Registrarse con Google</span>
                    </div>
                </button>
            </div>
        </div>
